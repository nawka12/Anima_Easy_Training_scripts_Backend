...
class OAGOpt(Optimizer):
    ...
    Two scalars, one momentum state, fully free descent. Featuring Muon's orthogonalization, RMS normalization, cautious stepping, and dual-normed adaptive update magnitudes.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(OAGOpt, self).__init__(params, defaults)
